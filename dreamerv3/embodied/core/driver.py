...
class Driver:
  ...
  def __init__(self, envs, **kwargs):
    ...
    # self._step_time_list = []
    # self._prediction_time_list = []
  ...
  def __call__(self, policy, steps=0, episodes=0, predictor=None):
    ...
    while step < steps or episode < episodes:
      ...
      # step, episode, action_time, step_time, pridiction_time = self._step(policy, step, episode, predictor)
      # self._action_time_list.append(action_time)
      # self._step_time_list.append(step_time)
      # self._prediction_time_list.append(pridiction_time)
      # print(self._action_time_list)
      # print(f'Average action time is {np.mean(self._action_time_list[1:])}, average step time is {np.mean(self._step_time_list[1:])}, average step time is {np.mean(self._prediction_time_list[1:])}')
  ...
  def _step(self, policy, step, episode, predictor=None):
    ...
    # print(action_time_2 - action_time_1)
    ...
    # return step, episode, action_time_2 - action_time_1, step_time_2 - step_time_1, prediction_time_2 - prediction_time_1
    return step, episode
